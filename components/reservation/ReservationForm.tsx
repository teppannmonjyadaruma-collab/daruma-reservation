...
豚焼きそば
※通常単品1皿分を2名様でシェアしていただきます。
※コースの焼きそばは、基本ソース味でのご提供となります。塩味へ変更をご希望の場合は、この後の「ご要望・備考」欄に、「焼きそば塩味へ変更希望」の旨と変更希望の人数をあわせてご記入ください。
...
ズーチーモー
ガーリックシュリンプ
※苦手な方はイカバター・じゃがチーズ・一口餃子・ ホルモン焼・鶏の柚子胡椒焼き・長芋ステーキの何れかに変更可
※変更をご希望の場合は、この後の「ご要望・備考」欄に、変更希望商品・変更希望人数とあわせてご記入ください。
ホタテバター
※通常単品1皿分を2名様でシェアしていただきます。
